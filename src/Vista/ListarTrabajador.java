...
public class ListarTrabajador extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblListarTrabajadores = new javax.swing.JTable();
        ...
        jLabel1.setText("Listar trabajadores");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        // TODO add your handling code here:
        try {
            int indice = tblListarTrabajadores.getSelectedRow();
            Trabajador trabajador = trabajadores.get(indice);
            TrabajadorDAO trabajadorDao = new TrabajadorDAO();
            if(trabajadorDao.eliminarTrabajador(trabajador.getId_trabajador())){
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        try {
           int indice = tblListarTrabajadores.getSelectedRow();
           trabajador = trabajadores.get(indice);
           
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null,"Seleccione un trabajador para modificar ");
        }
        
        ModificarTrabajador modificar = new ModificarTrabajador(trabajador);
    ...
    public void listar(){
        ...
        if(txtIdABuscar.getText().equals("")){
            ...
            Trabajador trabajador = trabajadorDao.buscarPorId(Integer.parseInt(txtIdABuscar.getText()));
        ...
        tblListarTrabajadores.setModel(modelo);
    ...
    private javax.swing.JTable tblListarTrabajadores;
